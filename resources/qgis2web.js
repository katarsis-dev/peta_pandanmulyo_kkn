...
//initial view - fokus pada Desa Pandanmulyo (epsg:3857)
if (typeof lyr_Pandanmulyocopy_4 !== 'undefined' && lyr_Pandanmulyocopy_4.getSource().getFeatures().length) {
    map.getView().fit(lyr_Pandanmulyocopy_4.getSource().getExtent(), {
        size: map.getSize(),
        padding: [50, 50, 50, 50],
        maxZoom: 17
    });
} else {
    map.getView().fit([12542514.998261, -903891.149431, 12547077.945973, -900808.779354], map.getSize());
}
